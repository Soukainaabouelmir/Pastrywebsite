...
.navbar .navbar-nav .nav-link.activeee {
    color:#e91e63;
}
...
<body>
    ...
    <section>
        <h2 class="section-title">Birthday Cake</h2>
        <div class="categories">
            
            <div class="category">
                <a href="{{route('menubirthday')}}" style="text-decoration: none; color:#151515;">
...
<div class="container my-5">
    <h1 class="text-center mb-4" style="color: #e91e63;">Menu des Gâteaux d'anneversiare</h1>
    @if ($hasProducts)
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
  ...
  $(document).ready(function() {
    $('#typeButton').click(function() {
        ...
        $.ajax({
            url: '/getbirthday-cake-types', // L'URL de votre route pour récupérer les types
            type: 'GET',
...
function filterProductsByType(type) {
    $.ajax({
        url: '/filter/birthday-products-by-type', // L'URL de votre route pour filtrer par type
        type: 'GET',
        data: {
...
<script>
    ...
    if (data.products.length === 0) {
        $('#productsContainer').append('<p>Aucun produit trouvé pour ce type/prix.</p>');
    } else {
        $.each(data.products, function(index, product) {
            $('#productsContainer').append(`
                <div class="col-md-4">
