...
.navbar .navbar-nav .nav-link.activeeee {
    color:#e91e63;
}
...
<body>
    ...
    <section>
        <h2 class="section-title">Simple Cake</h2>
...
<div class="container my-5">
    <h1 class="text-center mb-4" style="color: #e91e63;">Menu des Gâteaux Simple</h1>
    @if ($hasProducts)
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
  ...
  $(document).ready(function() {
    $('#typeButton').click(function() {
        ...
        $.ajax({
            url: '/getsimple-cake-types', // L'URL de votre route pour récupérer les types
            type: 'GET',
...
function filterProductsByType(type) {
    $.ajax({
        url: '/filter/simple-products-by-type', // L'URL de votre route pour filtrer par type
        type: 'GET',
        data: {
